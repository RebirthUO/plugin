...
- Keep `uo-modernuo-agent-plugin/.codex-plugin/plugin.json` and `uo-modernuo-agent-plugin/.claude-plugin/plugin.json` aligned for shared identity fields: `name`, `version`, `description`, and `author`.

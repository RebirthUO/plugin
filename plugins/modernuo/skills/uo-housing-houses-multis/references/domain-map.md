# Housing, Houses, and Multis Domain Map

Detailed architecture, permission/decay tables, examples, and historical observations deferred from the skill entrypoint. Verify limits, APIs, and facet policy in the active branch.
...
- `www.uoguide.com/Houses`, `/House_Decay`, and the Stratics decay archive are
  community discovery references only. They may help locate official material
  but cannot establish placement, access-list, IDOC, refresh, or timer rules.

# Harvest and Gathering Domain Map

Detailed architecture, vein/bonus tables, examples, and historical observations deferred from the skill entrypoint. Verify probabilities and race/facet rules in current source.

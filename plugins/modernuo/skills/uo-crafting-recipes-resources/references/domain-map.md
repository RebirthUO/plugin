# Crafting, Recipes, and Resources Domain Map

Detailed architecture, registration tables, examples, and historical observations deferred from the skill entrypoint. Verify recipe IDs and runtime APIs in the active branch.

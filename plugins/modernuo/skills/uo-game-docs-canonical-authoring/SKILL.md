...
- Implementation-status parity work — that's `02_Project_Parity/<Domain>/<Era>/<topic>.md` and `uo-modernuo-content-taxonomy`.
...
- For `02_Project_Parity/<Domain>/<Era>/` parity files: `modernuo-content-taxonomy` to anchor implementation status.
...
- `uo-era-publish-source-gate` — the umbrella that codifies this recipe as its "Phase 6 Fast Recipe: `game-docs/` authoring".
...
- `modernuo-content-taxonomy` — for the `02_Project_Parity/` implementation-status mirror.
